...
\begin{itemize}
    \setlength{\itemindent}{0.5em}
    \item[--] \small{\textbf{G.Sisto}, R.Chen, et al., ``Design and Optimization of SRAM Macro and Logic Using Backside
    Interconnects at 2nm Node'', IEDM 2021, San Francisco, USA} 
    ...
    and $\mu$- \& $n$- TSVs'', IITC 2021, Kyoto, Japan} 
\end{itemize}
\end{fullwidth}
