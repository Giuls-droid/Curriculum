...
%\photo{2cm}{ayoubpic}
\personalinfo{
    \email{giuliano.sisto1@gmail.com}
    \phone{+32 470 13 63 06}
    \phone{+39 340 41 09 479}
    \mailaddress{Emile van Arenberghstraat 23}
    ...
    %\href{https://orcid.org/0000-0001-8706-4311}temp
    %\orcid
    %\href{https://ieee-collabratec.ieee.org/app/myprofile/about}{temp\IEEE}
    %\href{https://scholar.google.com/citations?user=LMlRN0AAAAAJ&hl=it}{temp\Scholar}
}
